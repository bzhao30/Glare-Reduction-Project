...
begin
        ...
        if rising_edge(clk) then
            ...
            if activeArea = '1' then
                ...
                if prev_addr /= current_addr then
                    if doutb = "1111" or doutb = "1110" or doutb = "1101" then  
    ...
    begin
        if rising_edge(clk) then
            if activeArea = '0' and calcen = '1' then  -- Only calculate when active area is done
                ...
                elsif white_count = "0000000000000000" then
                    ysig <= 70;
                else
                    -- If no significant bright spots, default to center
                    xsig <= 80;
                    ysig <= -50;
                end if;
            end if;
    ...
    nextstate: process(cs, activeArea)
    begin
        rst <= '0';
        calcen <= '0';
        case cs is
